...
export default function Home() {
  const [formData, setFormData] = useState({
    nome: '', dtnasc: '', idade: '', alergia: '', quaisAlergias: '', 
    nomeResponsavel: '', celularResponsavel: '', 
    alergia: '', quaisAlergias: '', anoEvento: '2026',
    dtRegistro: new Date(), anoevento: '2026'
  })
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-4">Registro Treinamento Ministério Infantil 2026</h1>
